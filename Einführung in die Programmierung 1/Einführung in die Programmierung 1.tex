...
\end{code}
\end{minipage}
\\\\import java.util.Scanner;\\Scanner sc = new Scanner(System.in);\\Zeichenfolge bis newline einscannen: String zeichenfolge = sc.next();\\Zahlen einscannen: int zahl = sc.nextInt();
